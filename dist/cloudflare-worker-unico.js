// Ronda Editorial 2.1.1 — bundle autossuficiente para Cloudflare Workers
// Gerado em 2026-07-24T20:55:41.003Z
...
async function createIntelligentJob(db, { cacheKey, runId, topicId, staleMs = 10 * 60 * 1000, ttlMinutes = 120 } = {}) {
  await ensureSchema(db);
