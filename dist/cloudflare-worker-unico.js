// Ronda Editorial 2.4.0 — bundle autossuficiente para Cloudflare Workers
// Gerado em 2026-07-27T12:55:49.858Z
...
async function collectRound({ fetcher = fetch, now = new Date(), feeds = FEEDS, monitoringTerms = [] } = {}) {
