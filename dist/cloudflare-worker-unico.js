...
async function handleApi(request, env, url, ctx) {
  ...
  if (url.pathname.startsWith("/api/runs/") && request.method === "GET") {
    ...
    if (!/^[a-z0-9-]{8,80}$/i.test(runId)) throw new HttpError(400, "Identificador de ronda inv\xE1lido.");
