...
function buildCarouselBrief(topic = {}) {
  ...
  return {
    ...
    disclaimer: "Roteiro autom\xE1tico baseado nos t\xEDtulos e descri\xE7\xF5es dos feeds. Revise e confirme antes de publicar.",
    slides: [
...
function withEditorias(payload) {
  ...
  return {
    ...
    topics: payload.topics.map((topic) => {
      ...
      return enriched?.carousel?.slides?.length ? enriched : { ...enriched, carousel: buildCarouselBrief(enriched) };
    })
  };
}
