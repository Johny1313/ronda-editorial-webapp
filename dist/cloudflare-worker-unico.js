...
function withEditorias(payload) {
  ...
  return {
    ...payload,
    topics: payload.topics.map((topic) => topic?.editoria ? topic : { ...topic, editoria: classifyEditoria(topic?.items || []) })
  };
}
