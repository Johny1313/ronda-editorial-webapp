// Ronda Editorial 2.1.0 — bundle autossuficiente para Cloudflare Workers
// Gerado em 2026-07-24T17:25:20.556Z
...
async function createIntelligentJob(db, { cacheKey, runId, topicId, staleMs = 45_000, ttlMinutes = 120 } = {}) {
  await ensureSchema(db);
...
return { "handleRequest": handleRequest, "performRound": performRound, "processIntelligentCarouselJob": processIntelligentCarouselJob, "selfTest": selfTest, default: __default__ };
})();
