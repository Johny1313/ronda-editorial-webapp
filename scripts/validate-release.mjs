...
assert.match(articleReader, /source-evidence-v9-resilient-capacity/);
...
assert.match(articleReader, /maximumSupportedSlideCount/);
assert.match(articleReader, /slideCountAdjusted/);
